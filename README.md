...
<p>В настоящее время проект дорабатывается в ветке <b>development</b>: адаптируется верстка отдельных блоков, дописывается логика работы секции с формой "Оставить заявку", оптимизируется программный код</p>
